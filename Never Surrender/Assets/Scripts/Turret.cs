...
public class Turret : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        time += 0.01f;
        degrees = Mathf.Atan2(turret.transform.position.y - playerTarget.transform.position.y, turret.transform.position.x - playerTarget.transform.position.x) * Mathf.Rad2Deg + 90f;
